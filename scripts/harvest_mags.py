...
Usage:
    python3 scripts/harvest_mags.py --output-dir output --outdir harvest
"""
import argparse
import ast
import csv
...
DEFAULT_BINNERS = ["unitem", "comebin", "metadecoder", "semibin2_single"]
                    ...
                    for sample in samples:
                        ...
                        for bid in sorted(set(checkm) | set(gtdb)):
                            ...
                            row = [
                                ...
                                comp, con, _metric(rec, ("Strain heterogeneity",)),
                                _metric(rec, ("Genome size",)), _metric(rec, ("GC",)),
                                _metric(rec, ("# contigs", "contigs")), _metric(rec, ("Marker lineage",)),
                                _domain(cls), cls,
